...
public class TipoSalonCuenca extends javax.swing.JFrame {
    ...
    private static TipoSalonCuenca instancia; 
    public static synchronized TipoSalonCuenca getInstancia() {
        if (instancia == null) {
            instancia = new TipoSalonCuenca();
        }
        return instancia;
    }
...
public JLabel getTotalLabel() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoSalonCuenca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoSalonCuenca().setVisible(true);
            }
        });
    }
